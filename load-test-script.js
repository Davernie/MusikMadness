...
// Test configuration for full load testing (500 users)
export const options = {
  stages: [
    { duration: '30s', target: 100 }, // Ramp up to 100 users over 30 seconds
    { duration: '1m', target: 500 },  // Ramp up to 500 users over 1 minute (quicker ramp-up)
    { duration: '1m', target: 500 },  // Stay at 500 users for 1 minute (sustained load)
