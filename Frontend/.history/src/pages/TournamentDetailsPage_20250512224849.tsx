      ...
      <div className="w-full px-4 sm:px-6 pb-16 relative z-10">
        <div className="grid grid-cols-12 gap-4 lg:gap-6">
          ...
          <div className="col-span-12 md:col-span-3 lg:col-span-2 space-y-6">
            <div className="mt-[74px]"> {/* Push it down */}
          ...
          <div className="col-span-12 md:col-span-9 lg:col-span-10">
            {/* Split content and organizer info in a flex container */}
            <div className="flex flex-col lg:flex-row gap-6">
              {/* Tournament content with fixed height container to prevent layout shifts */}
              <div className="mb-6 lg:mb-14 min-h-[500px] lg:w-3/4">
                <TournamentContent
              ...
              {/* Organizer card - inline with content */}
          ...
          {/* Right sidebar - removed content moved to main area */}
          {/* <div className="col-span-12 md:col-span-3 lg:col-span-2 space-y-6">
