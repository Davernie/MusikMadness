...
const TournamentContent: React.FC<TournamentContentProps> = ({
  ...
  return (
    <Tabs defaultValue="overview" className="space-y-6">
      <TabsList className="bg-black/30 backdrop-blur-sm rounded-lg border border-white/10 p-1 mb-6 flex space-x-2 overflow-x-auto">
        <TabsTrigger 
          value="overview"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-black/30 backdrop-blur-sm rounded-xl border border-white/10 p-6">
                <h3 className="text-lg font-bold mb-4 text-white flex items-center">
                  <span 
                    className="inline-block w-1 h-4 rounded-full mr-2"
                    style={{ background: `rgba(${colors.primary}, 0.8)` }}
                  ></span>
                  Prize Distribution
                </h3>
