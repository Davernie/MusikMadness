      ...
      <div className="bg-gray-800/90 backdrop-blur-md rounded-xl border border-white/10 overflow-hidden">
        ...
        <div className="relative h-44 md:h-56">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center px-4">
            <h1 className="text-2xl md:text-4xl lg:text-5xl text-center font-bold mb-3" style={{ 
            ...
            <div className="flex flex-wrap items-center justify-center space-x-3 max-w-xl">
              {/* Genre */}
              <div 
                className="inline-flex items-center text-2xs px-2 py-0.5 rounded-full bg-gradient-to-r from-black/60 to-black/40 backdrop-blur-sm border border-white/10"
                style={{ boxShadow: `0 0 10px rgba(0,0,0,0.15)` }}
              >
                <Music className="h-2.5 w-2.5 mr-1" style={{ color: `rgba(${colors.primary}, 0.9)` }} />
                <span className="font-medium tracking-wide text-white">{genre}</span>
              </div>
              ...
              >
                ...
                <span className="font-medium tracking-wide text-white">{language}</span>
              </div>
              ...
              {/* Status */}
              <div 
                className={`inline-flex items-center text-2xs px-2 py-0.5 rounded-full bg-gradient-to-r from-black/60 to-black/40 backdrop-blur-sm border ${status === 'Open' ? 'border-emerald-500/30' : status === 'In Progress' ? 'border-cyan-500/30' : 'border-purple-500/30'}`}
                style={{ 
              ...
              >
                <span className={`font-medium tracking-wide ${getStatusTextColorClass()}`}>
                  {status}
                </span>
              </div>
              ...
              {daysLeft > 0 && status !== 'Completed' && (
                <>
                  ...
                  >
                    ...
                    <span className="font-medium tracking-wide text-white">{daysLeft}d left</span>
                  </div>
                </>
              )}
            </div>
        ...
        <div className="p-3 md:p-4 pt-3">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
              {/* Players */}
              <div className="relative overflow-hidden rounded-lg p-3 group transition-all duration-300 hover:translate-y-[-2px]"
                style={{
                  background: `linear-gradient(145deg, rgba(25,30,40,0.8), rgba(15,20,30,0.9))`,
                  boxShadow: `0 4px 15px rgba(0,0,0,0.25), inset 0 0 0 1px rgba(255,255,255,0.05)`
                }}
              >
                <div className="absolute -right-6 top-0 w-16 h-16 rounded-full opacity-20 blur-xl bg-cyan-500/40 group-hover:opacity-30 transition-opacity"></div>
                <div className="flex items-center mb-2">
                  <div className="p-1.5 rounded-full bg-cyan-500/10 mr-2">
                    <Users className="h-4 w-4 text-cyan-400" />
                  </div>
                  <span className="text-2xs font-medium text-gray-400 uppercase tracking-wider leading-none">Players</span>
                </div>
                <div className="flex items-baseline mt-1">
                  <span className="text-2xl font-bold text-white leading-none mr-1.5">{participants}</span>
                  <span className="text-sm text-cyan-300/70">/ {maxParticipants}</span>
                </div>
                <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-cyan-400/70 to-transparent scale-x-[0.7] group-hover:scale-x-100 transition-transform duration-500"></div>
              </div>
              ...
              >
                <div className="absolute -right-6 top-0 w-16 h-16 rounded-full opacity-20 blur-xl bg-green-500/40 group-hover:opacity-30 transition-opacity"></div>
                <div className="flex items-center mb-2">
                  <div className="p-1.5 rounded-full bg-green-500/10 mr-2">
                    <DollarSign className="h-4 w-4 text-green-400" />
                  </div>
                  <span className="text-2xs font-medium text-gray-400 uppercase tracking-wider leading-none">Entry Fee</span>
                </div>
                <div className="mt-1">
                ...
                <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-green-400/70 to-transparent scale-x-[0.7] group-hover:scale-x-100 transition-transform duration-500"></div>
              </div>
              ...
              {status === 'Open' ? (
                ...
                >
                  ...
                  <div className={`text-lg font-bold leading-none ${getStatusTextColorClass()}`}>
                    {status}
                  </div>
              ...
              >
                <div className="absolute -right-6 top-0 w-16 h-16 rounded-full opacity-20 blur-xl bg-purple-500/40 group-hover:opacity-30 transition-opacity"></div>
                <div className="flex items-center mb-2">
                  <div className="p-1.5 rounded-full bg-purple-500/10 mr-2">
                    <Calendar className="h-4 w-4 text-purple-400" />
                  </div>
                  <span className="text-2xs font-medium text-gray-400 uppercase tracking-wider leading-none">Tournament Dates</span>
                </div>
                <div className="flex flex-col mt-1">
                  <div className="flex items-center">
                    ...
                    <span className="text-sm font-bold text-white leading-tight">
                      {formatDate(endDate).replace(', 2023', '')}
                    </span>
                  </div>
                </div>
                <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-purple-400/70 to-transparent scale-x-[0.7] group-hover:scale-x-100 transition-transform duration-500"></div>
              </div>
              ...
              >
                <div className="absolute -right-6 top-0 w-16 h-16 rounded-full opacity-20 blur-xl bg-pink-500/40 group-hover:opacity-30 transition-opacity"></div>
                <div className="flex items-center mb-2">
                  <div className="p-1.5 rounded-full bg-pink-500/10 mr-2">
                    <Trophy className="h-4 w-4 text-pink-400" />
                  </div>
                  <span className="text-2xs font-medium text-gray-400 uppercase tracking-wider leading-none">Prize Pool</span>
                </div>
                <div className="mt-1">
                  <span className="text-2xl font-bold text-white leading-none">${prizePool.toLocaleString()}</span>
                </div>
                <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-pink-400/70 to-transparent scale-x-[0.7] group-hover:scale-x-100 transition-transform duration-500"></div>
              </div>
            </div>
          </div>
        </div>
