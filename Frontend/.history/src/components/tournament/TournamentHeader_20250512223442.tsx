            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
              ...
              >
                ...
                <div className="flex items-baseline justify-center gap-1">
                  ...
                  <span className="text-sm text-gray-400">/ {maxParticipants}</span>
                </div>
              </div>
              ...
              <div 
                ...
                style={{ boxShadow: `0 0 20px rgba(${colors.secondary}, 0.1)` }}
              >
                <DollarSign className="h-8 w-8 mb-2 text-green-400" />
              ...
              {status === 'Open' ? (
                <div className="flex items-center justify-center">
                  <button 
                    className="relative overflow-hidden py-5 px-8 rounded-xl font-medium text-white transition-all duration-300 bg-gradient-to-r hover:scale-[1.02] active:scale-[0.98] w-full h-full flex items-center justify-center"
                    style={{
                  ...
                  >
                    ...
                    ></div>
                    <span className="relative text-lg">Join Tournament</span>
                  </button>
                </div>
              ) : (
                <div 
              ...
              >
                ...
                ></div>
                <Trophy className="h-8 w-8 mb-2 text-pink-400" />
                <span className="text-sm text-gray-400 mb-1">Prize Pool</span>
                <div className="text-2xl font-bold text-white">${prizePool.toLocaleString()}</div>
              </div>
            </div>
          </div>
        </div>
