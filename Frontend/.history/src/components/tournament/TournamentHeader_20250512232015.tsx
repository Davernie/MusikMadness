              ...
              >
                ...
                <div className="mt-1 space-y-0.5">
                  <div className="flex items-center">
                    <div className="w-1 h-1 bg-purple-400/60 rounded-full mr-1.5"></div>
                    <span className="text-xs text-white/90 font-medium">
                      Start: <span className="text-purple-300">{formatDate(startDate).replace(', 2023', '')}</span>
                    </span>
                  </div>
                  <div className="flex items-center">
                    <div className="w-1 h-1 bg-purple-400/60 rounded-full mr-1.5"></div>
                    <span className="text-xs text-white/90 font-medium">
                      End: <span className="text-purple-300">{formatDate(endDate).replace(', 2023', '')}</span>
                    </span>
                  </div>
                </div>
