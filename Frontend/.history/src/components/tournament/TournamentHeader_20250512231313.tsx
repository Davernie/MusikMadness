            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
              ...
              {status === 'Open' ? (
                <div className="relative flex items-center justify-center h-full">
                  <button 
                    className="w-full py-3 px-4 rounded-lg font-semibold text-white transition-all duration-300 relative"
                    style={{
                  ...
                  >
                    <span className="relative z-10 flex items-center justify-center">
                      <Trophy className="h-4 w-4 mr-2 hover:rotate-12 transition-transform duration-300" style={{filter: "drop-shadow(0 0 2px rgba(255,255,255,0.4))"}} />
                      Join Tournament
                    </span>
                    <div 
                    ...
                    ></div>
                    <div className="absolute bottom-0 left-0 w-full h-1 bg-white/20 scale-x-0 hover:scale-x-100 transition-transform origin-left duration-300"></div>
                  </button>
                </div>
              ) : (
                <div className="relative overflow-hidden rounded-lg p-2.5 group transition-all duration-300 hover:translate-y-[-2px]"
              ...
              >
                ...
                <div className="flex items-center mb-1">
                  ...
                  <span className="ml-1.5 text-2xs font-medium text-gray-400 uppercase tracking-wider leading-none">Dates</span>
                </div>
              ...
              >
                ...
                <div className="text-lg font-bold text-white leading-none">${prizePool.toLocaleString()}</div>
