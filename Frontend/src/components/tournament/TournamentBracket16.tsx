      ...
      <div className={styles.bracketScaler16}>
        ...
        <div className="p-4 md:p-5">
          <div className={styles.bracket16}>
            ...
            {/* Championship - positioned in original location with 32-bracket style */}
            ...
            {/* Semifinal 1 - Left side - RESTORED to original position */}
            ...
            {/* Semifinal 2 - Right side - RESTORED to original position */}
