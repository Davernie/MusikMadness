...
import { Mic, Facebook, Twitter, Instagram, Mail } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold bg-gradient-to-r from-blue-400 to-pink-400 bg-clip-text text-transparent">
                MusikMadness
              </span>
            </div>
            <p className="text-gray-300 text-sm mt-2">
              The ultimate platform for musicians to compete and showcase their talent through tournaments.
            </p>
          </div>
          ...
          <div className="col-span-1">
            ...
            <div className="mt-2 flex">
              <input 
                ...
                className="bg-gray-800 text-gray-200 px-4 py-2 rounded-l-md focus:outline-none focus:ring-2 focus:ring-blue-500 flex-grow"
              />
              <button className="bg-gradient-to-r from-blue-500 to-pink-500 px-4 py-2 rounded-r-md font-medium">
                Join
              </button>
            </div>
          </div>
