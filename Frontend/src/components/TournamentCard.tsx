          ...
          <div className="relative overflow-hidden rounded-xl h-full backdrop-blur-sm bg-black/20">
            ...
            <div className="p-6 h-full flex flex-col">
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  {organizer.socials?.kick && (
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="p-2 rounded-full bg-white/5 hover:bg-white/10 transition-colors border border-white/10 flex items-center justify-center w-8 h-8"
                      onClick={(e) => e.stopPropagation()}
                      title="Kick"
                    >
                      <span className="text-sm font-black text-[#53fc18]" style={{ fontFamily: 'Impact, Arial Black, sans-serif', lineHeight: '1' }}>K</span>
                    </a>
                  )}
                  {organizer.website && (
                    <a 
                ...
                {(!organizer.socials?.instagram && !organizer.socials?.twitter && !organizer.website && !organizer.socials?.soundcloud && !organizer.socials?.spotify && !organizer.socials?.youtube && !organizer.socials?.twitch && !organizer.socials?.kick) && (
