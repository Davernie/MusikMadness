        ...
        >
          <div className="group relative overflow-hidden rounded-xl transition-all duration-500 hover:transform hover:-translate-y-1 h-full backdrop-blur-sm">
            ...
            <div className="relative p-6 h-full flex flex-col">
              ...
              {/* View Details Button - With subtle color accent */}
              ...
              <div className="mt-auto">
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div className="bg-white/5 rounded-lg p-4 border border-white/5">
                    <div className="text-xs text-gray-400 uppercase tracking-wider">Tournaments</div>
                    <div 
                ...
                <p className="text-center text-xs text-gray-500">Click card to flip back</p>
              </div>
            </div>
          </div>
        </div>
