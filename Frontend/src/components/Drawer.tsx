        ...
        <nav className="flex-1 px-2 py-4 space-y-2">
          ...
          {isAuthenticated && (
            ...
            >
              ...
              <span className={navTextClass}>Profile</span>
            </Link>
          )}
        </nav>
        ...
        <div className="p-4 border-t border-gray-700/20">
          {isAuthenticated ? (
            ...
            >
              ...
              <span className={`ml-4 whitespace-nowrap transition-all duration-300 font-crashbow ${isOpen ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-4'}`}>
                Logout
              </span>
            </button>
          ) : (
