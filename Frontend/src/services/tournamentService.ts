...
class TournamentService {
  ...
  async getUserCreatedTournaments(userId: string): Promise<Tournament[]> {
    const response = await axios.get(`${API_BASE_URL}/users/${userId}/tournaments/created`, {
      headers: getDefaultHeaders(),
    });
    return response.data;
  }
  ...
  async getUserJoinedTournaments(userId: string): Promise<Tournament[]> {
    const response = await axios.get(`${API_BASE_URL}/users/${userId}/tournaments/joined`, {
      headers: getDefaultHeaders(),
    });
    return response.data;
  }
