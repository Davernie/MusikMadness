...
// Test configuration for gradual load testing (start smaller)
export const options = {
  ...
  thresholds: {
    http_req_duration: ['p(95)<5000'], // More lenient - 95% of requests should be below 5 seconds
    http_req_failed: ['rate<0.2'],     // More lenient - Error rate should be below 20%
    errors: ['rate<0.2'],              // More lenient - Custom error rate should be below 20%
  },
};
