...
const HowItWorks: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Background gradient line - optimized for smooth scrolling */}
      <div 
        className="absolute top-0 left-1/2 w-full max-w-sm h-1 bg-gradient-to-r from-cyan-500 via-purple-500 to-pink-500 will-change-transform"
        style={{
