...
const Drawer = () => {
  ...
  const navTextClass = (isDropdownItem?: boolean) => `
    ml-4 whitespace-nowrap 
    transition-all duration-300 
    font-crashbow ${isDropdownItem ? 'text-sm' : 'text-lg'}
