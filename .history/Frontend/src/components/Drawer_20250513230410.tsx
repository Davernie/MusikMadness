      ...
      <div className="flex flex-col h-full">
        ...
        <nav className="flex-1 px-2 py-4 space-y-2">
          ...
          >
            ...
            <span className={`ml-4 whitespace-nowrap transition-all duration-300 ${isOpen ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-4'}`}>Home</span>
          </Link>
          ...
          >
            ...
            <span className={`ml-4 whitespace-nowrap transition-all duration-300 ${isOpen ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-4'}`}>Tournaments</span>
          </Link>
          ...
          >
            ...
            <span className={`ml-4 whitespace-nowrap transition-all duration-300 ${isOpen ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-4'}`}>Create Tournament</span>
          </Link>
          ...
          >
            ...
            <span className={`ml-4 whitespace-nowrap transition-all duration-300 ${isOpen ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-4'}`}>Settings</span>
          </Link>
        </nav>
