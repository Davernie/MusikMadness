...
const Drawer = () => {
  ...
  return (
    <div className="relative">
      {/* Hover trigger zone - only visible when drawer is collapsed */}
      {!isOpen && (
        <div 
          className="fixed left-0 top-0 w-24 h-full z-[60]"
      ...
      <div className="flex flex-col h-full">
        <div 
          className="flex items-center justify-start px-1 py-4"
        ...
        <div 
          className="p-4 border-t border-gray-700/20"
          onMouseEnter={handleIconHover}
        >
          {isAuthenticated ? (
            <button 
