  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="relative overflow-hidden rounded-xl h-full backdrop-blur-sm bg-black/20 cursor-pointer"
            ...
            <div className="p-6 h-full flex flex-col">
              ...
              <div className="mt-auto space-y-3">
                ...
                <p className="text-center text-xs text-gray-500 mt-2">Click card to flip</p>
              </div>
            </div>
          </div>
        </div>
