...
const CallToActionTitle = React.memo(() => (
  <h2 
    className="text-3xl sm:text-4xl font-bold mb-6 text-white will-change-transform"
    style={{ 
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div 
          className="backdrop-blur-sm bg-black/30 p-8 rounded-2xl border border-gray-800/40"
          style={{ 
            contain: 'layout style paint',
