...
const SoundCloudPlayer: React.FC<SoundCloudPlayerProps> = ({
  ...
  const toggleVolumeControl = (e?: React.MouseEvent) => {
    ...
    console.log('Toggle volume control clicked, current state:', showVolumeControl);
    console.log('Widget available:', !!widget);
    console.log('Current volume:', volume);
    setShowVolumeControl(prev => {
      console.log('Setting showVolumeControl to:', !prev);
      return !prev;
    });
  };
