    ...
    >
      <div className="flex flex-col h-full">
        ...
        <nav className="flex-1 px-2 py-4 space-y-2">
          <Link 
            to="/" 
            className={`flex items-center px-4 py-3 transition-colors duration-200 rounded-lg hover:bg-gray-700/20 tracking-wider ${
              isActive('/') 
                ? 'text-purple-400' 
          ...
          >
            ...
            <span className={`ml-4 whitespace-nowrap transition-all duration-300 font-crashbow text-lg tracking-wide leading-relaxed ${isOpen ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-4'}`}>Home</span>
          </Link>
