      ...
      <div className="flex flex-col h-full">
        ...
        <nav className="flex-1 px-2 py-4 space-y-2">
          ...
          >
            ...
            <span className={navTextClass}>Leaderboardasdfasdfasdfasdfasdfsafafs</span>
          </Link>
