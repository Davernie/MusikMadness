      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center justify-center mt-[-2rem] md:mt-[-3rem] pt-0">
              <img 
                src={logoImage} 
                alt="MusikMadness" 
          ...
          <div className="col-span-1">
            ...
            <div className="mt-2 flex flex-col sm:flex-row">
              <input 
                ...
                className="bg-gray-800/50 text-gray-200 px-4 py-2 rounded-md sm:rounded-l-md sm:rounded-r-none focus:outline-none focus:ring-2 focus:ring-blue-500 flex-grow border border-white/10 mb-2 sm:mb-0"
              />
              <button className="bg-gradient-to-r from-blue-500/80 to-pink-500/80 hover:from-blue-500 hover:to-pink-500 px-4 py-2 rounded-md sm:rounded-l-none sm:rounded-r-md font-medium transition-all duration-300">
                Join
              </button>
            </div>
          </div>
        ...
        <div className="border-t border-white/5 mt-8 md:mt-12 pt-6 md:pt-8 text-center text-gray-400/80 text-sm">
