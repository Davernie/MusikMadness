...
// Use environment variable instead of hardcoded (restore when working)
...
const GoogleLoginButton: React.FC<GoogleLoginButtonProps> = ({
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // Initialize Google Sign-In with exact same config as debug page
      ...
      // Trigger the button automatically after a short delay
      setTimeout(() => {
        ...
        if (hiddenButton) {
          ...
          console.log('Button not found, rendering failed');
          setIsLoading(false);
  ...
  return (
    <div className="google-login-container">
      ...
      {/* Hidden div for Google button rendering (same as debug page) */}
...
export default GoogleLoginButton;const handleGoogleLogin = async () => {
    console.log('Google login button clicked');
    ...
    try {
      ...
      window.google.accounts.id.initialize({
        ...
        callback: handleCredentialResponse,
        auto_select: false,
      });      // Skip the One Tap prompt and go directly to the popup button (works better)
      console.log('Rendering Google Sign-In button directly...');
      window.google.accounts.id.renderButton(
        document.getElementById('google-signin-button'),
        {
          theme: 'outline',
