...
const StreamCard: React.FC<StreamCardProps> = ({ stream }) => {
  ...
  return (
    <div 
      className="group relative overflow-hidden rounded-xl transition-all duration-500 hover:transform hover:-translate-y-1 h-full backdrop-blur-sm border border-white/5"
