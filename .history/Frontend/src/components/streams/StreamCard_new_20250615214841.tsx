    ...
    >
      ...
      <div className="relative p-6">
        ...
        <div className="space-y-2">
          ...
          {streamer.isLive && (
            <button
              onClick={() => onWatchHere(streamer)}
              className="w-full flex items-center justify-center space-x-2 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 hover:from-cyan-500/30 hover:to-blue-500/30 border border-cyan-500/30 rounded-lg py-2 px-4 transition-all duration-300 group-hover:scale-[1.02]"
            >
              <Play className="h-4 w-4 text-cyan-400" />
              <span className="text-cyan-400 text-sm">Watch Here</span>
            </button>
          )}
        </div>
