...
const SoundCloudPlayer: React.FC<SoundCloudPlayerProps> = ({
  ...
  const embedUrl = (() => {
    if (originalUrl) {
      ...
      params.append('show_artwork', 'true');
      params.append('visual', 'true');
      params.append('color', 'ff6600');
      return `https://w.soundcloud.com/player/?${params.toString()}`;
    } else if (trackId) {
      // Fallback to trackId-based embed URL
      return `https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/${trackId}&auto_play=${autoplay}&show_artwork=true&visual=true&color=ff6600`;
    }
    return '';
  })();
