  ...
  return (
    ...
    >
      ...
      >
        {/* Front of card */}
        <div 
          className="absolute w-full h-full backface-hidden rounded-xl cursor-pointer"
          style={{ 
        ...
        >
          <div className="relative overflow-hidden rounded-xl h-full backdrop-blur-sm bg-black/20">
            ...
            <div className="p-6 h-full flex flex-col">
              ...
              {/* Organizer Bio */}
              <div className="mb-6 bg-white/5 p-4 rounded-lg border border-white/5 cursor-pointer"
                   onClick={() => setIsFlipped(false)}>
              ...
              {/* Social Links */}
              <div className="mb-6 cursor-pointer" onClick={() => setIsFlipped(false)}>
              ...
              <div className="mt-auto space-y-3">
                ...
                <p className="text-center text-xs text-gray-500 mt-2 cursor-pointer" 
                   onClick={() => setIsFlipped(false)}>Click card to flip</p>
              </div>
            </div>
          </div>
        </div>
