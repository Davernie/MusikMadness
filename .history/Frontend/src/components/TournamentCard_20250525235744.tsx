      ...
      >
        ...
        >
          <div className="group relative overflow-hidden rounded-xl transition-all duration-500 hover:transform hover:-translate-y-1 h-full backdrop-blur-sm">
            ...
            <div className="relative p-6 h-full flex flex-col">
              {/* Cover Image Section - Clickable area to flip */}
              <div 
                className="relative overflow-hidden rounded-lg mb-5 cursor-pointer"
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-300 bg-black/20">
                  <span className="text-white text-sm font-medium px-3 py-1 rounded-full bg-black/50 backdrop-blur-sm">
        ...
        >
          <div className="relative overflow-hidden rounded-xl h-full backdrop-blur-sm bg-black/20">
            ...
            {/* Accent color bar at top - Clickable area to flip back */}
            <div 
            ...
            <div className="p-6 h-full flex flex-col">
              ...
              <div className="flex items-center mb-6 pb-5 border-b border-white/5">
                ...
                <div className="ml-4">
                  <button
                    onClick={handleViewProfile}
                    className="hover:opacity-80 transition-opacity duration-200 block text-left"
                  >
              ...
              {/* Organizer Bio - Clickable area to flip back */}
              <div 
                className="mb-6 bg-white/5 p-4 rounded-lg border border-white/5 cursor-pointer"
                onClick={handleFlipToFront}
              >
