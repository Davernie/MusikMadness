...
const PlayerThumbnail = React.memo<{
  ...
  // List of thumbnail URLs to try in order
  const thumbnailSources = useMemo(() => {
    ...
    // Try different YouTube qualities
    sources.push(
  ...
  const handleError = useCallback((e: React.SyntheticEvent<HTMLImageElement>) => {
    console.log('YouTube thumbnail error for videoId:', videoId, 'source index:', currentSrcIndex, 'src:', thumbnailSources[currentSrcIndex]);
  ...
  }, [currentSrcIndex, thumbnailSources, videoId, onImageError]);
  
  const handleLoad = useCallback(() => {
    console.log('YouTube thumbnail loaded successfully for:', videoId, 'source:', thumbnailSources[currentSrcIndex]);
    setHasError(false);
  }, [videoId, thumbnailSources, currentSrcIndex]);
