...
const TournamentBracket: React.FC = () => {
  return (
    <>
      <div className="relative z-10 py-4 w-full max-w-[2000px] mx-auto overflow-x-auto">
        <div className="bg-gray-800/90 backdrop-blur-md rounded-xl border border-white/10 overflow-hidden min-w-[1800px]">
          <header>
            <ol>
