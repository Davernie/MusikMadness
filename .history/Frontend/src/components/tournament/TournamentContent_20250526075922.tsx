          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-5">
              ...
              <div className="flex items-center space-x-3"> {/* Added items-center for vertical alignment */}
                {/* Beautiful circular genre badge */}
                <div className="relative group">
                  <div className="h-10 w-10 flex items-center justify-center rounded-full transition-all duration-300 ease-in-out hover:scale-105"
                    style={{
                      background: `radial-gradient(circle at center, rgba(${genreSpecificColors.primary}, 0.15), rgba(${genreSpecificColors.primary}, 0.05))`,
                      border: `1px solid rgba(${genreSpecificColors.primary}, 0.3)`,
                      boxShadow: `0 0 15px rgba(${genreSpecificColors.primary}, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.1)`
                    }}>
                    <span className="font-semibold text-xs tracking-wide transition-all duration-300" style={{ 
                      color: `rgba(${genreSpecificColors.primary}, 0.9)`,
                      textShadow: `0 0 10px rgba(${genreSpecificColors.primary}, 0.2)`
                    }}>{genre.substring(0,3).toUpperCase()}</span>
                  </div>
                  {/* Subtle glow effect on hover */}
                  <div className="absolute inset-0 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                    style={{
                      background: `radial-gradient(circle, rgba(${genreSpecificColors.primary}, 0.1), transparent 70%)`,
                      filter: 'blur(4px)'
                    }}>
                  </div>
                </div>
                {/* Elegant language badge */}
                <div className="px-3 py-1.5 rounded-lg border transition-all duration-300 hover:scale-105" 
                  style={{
                    backgroundColor: `rgba(${colors.secondary}, 0.08)`,
                  ...
                  <span className="text-xs font-medium tracking-wide" style={{ 
                    color: `rgba(${colors.secondary}, 0.85)`
