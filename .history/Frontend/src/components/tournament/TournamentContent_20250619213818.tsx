        ...
        >
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-800/80 backdrop-blur-sm rounded-xl border border-white/10 p-6">                <h3 className="text-lg mb-4" style={{ 
                    fontFamily: "'Crashbow', 'Impact', sans-serif",
                    color: 'white',
                    textShadow: '2px 2px 4px rgba(0, 0, 0, 0.8)',
                    letterSpacing: '3px'
              ...
              <div className="bg-gray-800/80 backdrop-blur-sm rounded-xl border border-white/10 p-6">                <h3 className="text-lg mb-4 flex items-center" style={{ 
                    fontFamily: "'Crashbow', 'Impact', sans-serif",
                    color: 'white',
                    textShadow: '2px 2px 4px rgba(0, 0, 0, 0.8)',
                    letterSpacing: '3px'
