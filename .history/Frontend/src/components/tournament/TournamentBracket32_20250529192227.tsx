...
const TournamentBracket32: React.FC<TournamentBracket32Props> = ({ participants, generatedBracket }) => {
  ...
  // Create finalFourMatchups by combining both semifinals
  const finalFourMatchups = useMemo(() => [...semifinal1, ...semifinal2], [semifinal1, semifinal2]);
      ...
      <div className={styles.bracketScaler32}>
        ...
        <div className="p-4 md:p-5">
          <div className={styles.bracket32}>
            ...
            <div className={styles['semifinals32']}>
              {finalFourMatchups.map((match, index) => {
                const className = index === 0 ? "matchup32-31" : "matchup32-32";
                return (
                  <BracketMatch 
                    key={match.matchupId} 
