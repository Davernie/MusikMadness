          ...
          <div className="p-4 md:p-5">
            <div className={styles.bracket}>
              ...
              <div className={`${styles.region} ${styles['region-3']}`}>
                  ...
                  {elite8Region3.map((match) => <BracketMatch key={match.matchupId} matchupClass="matchup-59" matchupId={match.matchupId} player1={{ username: match.player1.displayName, score: match.player1.score, id: match.player1.participantId }} player2={{ username: match.player2.displayName, score: match.player2.score, id: match.player2.participantId }} /> )}
              </div>
