...
const TournamentBracket: React.FC = () => {
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="relative z-10 py-4 w-[1800px]">
            ...
            <div className={styles.bracket}>
              ...
              <div className={`${styles.region} ${styles['region-1']}`}>
                ...
                <BracketMatch
                  ...
                  player1={{ name: 'Winner Sweet 16 1', score: 89 }}
                  player2={{ name: 'Winner Sweet 16 2', score: 82 }}
                />
              </div>
              ...
              <div className={`${styles.region} ${styles['region-2']}`}>
                ...
                <BracketMatch
                  ...
                  player1={{ name: 'Winner Sweet 16 3', score: 91 }}
                  player2={{ name: 'Winner Sweet 16 4', score: 87 }}
                />
              </div>
              ...
              <div className={`${styles.region} ${styles['region-3']}`}>
                ...
                <BracketMatch
                  ...
                  player1={{ name: 'Winner Sweet 16 5', score: 94 }}
                  player2={{ name: 'Winner Sweet 16 6', score: 88 }}
                />
              </div>
              ...
              <div className={`${styles.region} ${styles['region-4']}`}>
                ...
                <BracketMatch
                  ...
                  player1={{ name: 'Winner Sweet 16 7', score: 93 }}
                  player2={{ name: 'Winner Sweet 16 8', score: 90 }}
                />
              </div>
              ...
              <div className={styles['final-four']}>
                ...
                <BracketMatch
                  ...
                  player1={{ name: 'Winner Region 1', score: 85 }}
                  player2={{ name: 'Winner Region 2', score: 78 }}
                />

                {/* Final Four Game 2 */}
                <BracketMatch
                  matchupClass="matchup-62"
                  player1={{ name: 'Winner Region 3', score: 92 }}
                  player2={{ name: 'Winner Region 4', score: 89 }}
                />

                {/* Championship */}
                <BracketMatch
                  matchupClass="championship"
                  player1={{ name: 'Winner Region 1', score: 88 }}
                  player2={{ name: 'Winner Region 3', score: 95 }}
                />
              </div>
            </div>
          </div>
