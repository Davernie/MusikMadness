...
const OrganizerCard: React.FC<OrganizerCardProps> = ({
  ...
  // Avoid unused variable warnings by using them or removing if not needed
  console.log('Tournament stats:', { participants, prizePool });
      ...
      <div className="p-6 flex-grow flex flex-col">
        ...
        <div className="space-y-5 flex-grow flex flex-col">
          ...
          <div className="flex gap-3 pt-4">
            ...
            {!organizer.socials?.instagram && !organizer.socials?.twitter && !organizer.website && !organizer.socials?.website && (
