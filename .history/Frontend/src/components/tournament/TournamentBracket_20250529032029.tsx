        ...
        <div className={styles.bracketScaler} data-tournament-size={actualBracketSize}>
          <header>
            <ol>
              ...
              {/* Top 8A - only show for 32+ participants */}
              {actualBracketSize >= 32 ? <li>Top 8A</li> : <li style={{ visibility: 'hidden' }}>Top 8A</li>}
              ...
              {/* Top 8B - only show for 32+ participants */}
              {actualBracketSize >= 32 ? <li>Top 8B</li> : <li style={{ visibility: 'hidden' }}>Top 8B</li>}
