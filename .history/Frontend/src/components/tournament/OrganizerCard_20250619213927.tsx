...
const OrganizerCard: React.FC<OrganizerCardProps> = ({
  ...
  const organizerProfileLink = organizer.id ? `/profile/${organizer.id}` : '#';  return (
    <div 
      className="rounded-xl shadow-lg overflow-hidden border border-white/5 relative group"
      style={{
    ...
    >
      ...
      ></div>      
      <div className="p-6">        <h3 className="text-lg mb-4" style={{ 
