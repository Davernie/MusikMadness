...
const TournamentBracket: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className={`relative z-10 py-4 w-[${containerWidth}]`} style={{ width: containerWidth }}>
        <div className="bg-gray-800/90 backdrop-blur-md rounded-xl border border-white/10">
          ...
          <header>
            <ol>
              {bracketSize >= 64 && <li>Round 1A</li>}
              {bracketSize >= 32 && <li>Round 2A</li>}
              <li>Round 3A</li>
              <li>QTR Final</li>
              <li>Finals</li>
              <li>QTR Final</li>
              <li>Round 3B</li>
              {bracketSize >= 32 && <li>Round 2B</li>}
              {bracketSize >= 64 && <li>Round 1B</li>}
            </ol>
          </header>
