...
import { Calendar, Award, Users, Music } from 'lucide-react'; // Added Music icon
        ...
        <div className="bg-gray-800/80 backdrop-blur-sm rounded-xl shadow-lg overflow-hidden border border-white/5">
          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center"> {/* Added a div to group icon and text */}
                <Music className="h-6 w-6 mr-3" style={{ color: `rgb(${genreSpecificColors.primary})` }} /> {/* Added Music icon with dynamic color */}
                <h2 className="text-xl" style={{ 
                    fontFamily: "'Crashbow', 'Impact', sans-serif",
                    color: `rgb(${colors.primary})`, // Kept original color for text, or could use genreSpecificColors.primary
                    letterSpacing: '3px'
                  }}>
