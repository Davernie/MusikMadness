            ...
            <div className="flex items-center justify-between mb-5">
              ...
              <div className="flex space-x-2">
                <div className="px-3 py-1 rounded-md border-l-2 border-white/5"
                  style={{
                    borderLeftColor: `rgba(${genreSpecificColors.primary}, 0.7)`, // Use genre-specific color for border
                    background: `linear-gradient(90deg, rgba(${genreSpecificColors.primary}, 0.1), transparent)` // Use genre-specific color for background
                  }}>
                  <span className="text-white/90 font-medium text-sm" style={{
                    color: `rgb(${genreSpecificColors.primary})`, // Apply genre-specific color to text
                    textShadow: `0 0 10px rgba(${genreSpecificColors.primary}, 0.3)`
                  }}>{genre}</span>
                </div>
