          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-5">
              ...
              <div className="flex items-center space-x-2"> {/* Added items-center for vertical alignment */}
                {/* The existing genre display div is replaced by the circular one below */}
                <div className="h-8 w-8 flex items-center justify-center rounded-full p-2"
                  style={{
                    backgroundColor: `rgba(${genreSpecificColors.primary}, 0.2)`, 
                    border: `1px solid rgba(${genreSpecificColors.primary}, 0.7)`, 
                  }}>
                  <span className="text-white/90 font-medium text-xs" style={{ 
                    color: `rgb(${genreSpecificColors.primary})`, 
                    textShadow: `0 0 8px rgba(${genreSpecificColors.primary}, 0.3)`
                  }}>{genre.substring(0,3)}</span> {/* Displaying first 3 chars for brevity in circle */}
                </div>
