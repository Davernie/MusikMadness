          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-5">
              ...
              <div className="flex space-x-3">
                <div className="px-3 py-1.5 rounded-lg border border-white/10 bg-gray-900/50 backdrop-blur-sm hover:bg-gray-800/50 transition-all duration-300 group">
                  <span className="text-white/60 text-xs font-medium block">Genre</span>
                  <span className="text-white font-medium" style={{ 
                    textShadow: `0 0 8px rgba(${colors.primary}, 0.5)`,
                    color: `rgb(${colors.primary})`
                  }}>{genre}</span>
                </div>
                <div className="px-3 py-1.5 rounded-lg border border-white/10 bg-gray-900/50 backdrop-blur-sm hover:bg-gray-800/50 transition-all duration-300 group">
                  <span className="text-white/60 text-xs font-medium block">Language</span>
                  <span className="text-white font-medium" style={{ 
                    textShadow: `0 0 8px rgba(${colors.secondary}, 0.5)`,
