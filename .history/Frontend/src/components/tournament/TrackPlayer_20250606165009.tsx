...
interface TrackPlayerProps {
  track: {
    ...
    artist: string;
    audioUrl: string;
    streamUrl?: string | null; // New field for presigned URLs    audioType?: 'r2' | 'local' | 'youtube' | 'soundcloud'; // Added YouTube and SoundCloud support
...
const TrackPlayer: React.FC<TrackPlayerProps> = ({ track, competitorId, competitorProfileImage, isLeft, gradientStart, gradientEnd, onUrlRefreshNeeded }) => {
  // Debug logging for YouTube tracks
  useEffect(() => {
