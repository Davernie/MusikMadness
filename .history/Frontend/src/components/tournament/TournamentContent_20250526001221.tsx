...
import { Calendar, Award, Users, Music, Globe } from 'lucide-react';
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    {genre && (
                      ...
                      >
                        <Music className="h-3.5 w-3.5 mr-1.5" style={{ color: `rgba(${safeColors.primary}, 1)` }} />
                        {genre}
                      </div>
                    )}
                    
                    {language && (
                      <div className="px-3 py-1.5 rounded-full text-xs font-medium bg-white/10 border border-white/20 text-gray-300 inline-flex items-center">
