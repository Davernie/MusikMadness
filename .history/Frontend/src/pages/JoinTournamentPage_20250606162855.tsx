...
import { ArrowLeft, Music, UploadCloud, Info, Youtube, FileMusic, AudioLines } from 'lucide-react';
...
const JoinTournamentPage: React.FC = () => {
  ...
  const [submissionType, setSubmissionType] = useState<'file' | 'youtube'>('file');
