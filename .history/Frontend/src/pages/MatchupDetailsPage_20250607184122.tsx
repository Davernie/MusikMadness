      ...
      if (response.ok) {
        ...
        if (p1Stream && newMatchup.player1.submission) {
          ...
          if (p1Stream.audioType === 'youtube' && p1Stream.videoId) {
            ...
            newMatchup.player1.submission.soundcloudArtwork = p1Stream.artwork;
            newMatchup.player1.submission.soundcloudUsername = p1Stream.username;
            newMatchup.player1.submission.soundcloudUrl = p1Stream.streamUrl;
        ...
        if (p2Stream && newMatchup.player2.submission) {
          ...
          if (p2Stream.audioType === 'youtube' && p2Stream.videoId) {
            ...
            newMatchup.player2.submission.soundcloudArtwork = p2Stream.artwork;
            newMatchup.player2.submission.soundcloudUsername = p2Stream.username;
            newMatchup.player2.submission.soundcloudUrl = p2Stream.streamUrl;
