...
const LoginPage: React.FC = () => {
  ...
  const { login, loading, error, fieldErrors, isAuthenticated } = useAuth();
  ...
  return (
    <div className="min-h-[20rem] flex items-center justify-center py-0 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="mt-8">
          <div className="bg-gray-800/60 backdrop-blur-sm py-8 px-6 shadow-md rounded-xl border border-cyan-500/20 shadow-[0_0_15px_rgba(0,204,255,0.15)]">            {(error || formError) && (
                ...
                <div className="flex-1">
                  ...
                  {(error && error.includes('verify your email')) && (
                    <p className="text-xs mt-2 text-cyan-400">
                      <Link to="/resend-verification" className="underline hover:text-cyan-300">
