...
const SettingsPage: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-[500px] h-[500px] rounded-full bg-blue-500/20 blur-[120px]" />
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] rounded-full bg-pink-500/20 blur-[120px]" />
      ...
      <div className="relative backdrop-blur-xl bg-white/5 min-h-screen">
        <div className="flex min-h-screen">
          {/* Sidebar with enhanced glass effect */}
          <div className="w-64 backdrop-blur-lg bg-gray-900/40 border-r border-white/10">
            <div className="p-6">
          ...
          <div className="flex-1 py-12 px-8 backdrop-blur-sm bg-gray-900/20">
