...
import { Music, Mail, AlertCircle, CheckCircle, Loader, ArrowLeft } from 'lucide-react';
            ...
            {status === 'success' && (
              <div className="text-center space-y-4">
                ...
                <p className="text-white">
                  Check your email inbox and click the password reset link if you have an account with us.
                </p>
