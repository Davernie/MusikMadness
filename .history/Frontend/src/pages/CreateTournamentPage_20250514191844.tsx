...
const CreateTournamentPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen py-12 relative overflow-hidden bg-grid-pattern">
      {/* Background effects */}
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Enhanced progress indicators with neon effect */}
        <div className="mb-10">
        ...
        {/* Enhanced main card with neon glass effect */}
        <div 
          className="neon-card p-8 mb-8 relative"
          style={{ '--hue1': '200', '--hue2': '335' } as React.CSSProperties}
        >
                ...
                <div className="space-y-8">
                  <div className="group">
                    ...
                    <input 
                      ...
                      required
                      className="w-full px-4 py-3 bg-gray-800/70 border-2 border-gray-700/80 rounded-lg shadow-sm focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-white transition-all duration-200 placeholder:text-gray-500 hover:border-gray-600/90 neon-card-button"
                  ...
                  <div className="group">
                    ...
                    <textarea 
                      ...
                      required
                      rows={4}
                      className="w-full px-4 py-3 bg-gray-800/70 border-2 border-gray-700/80 rounded-lg shadow-sm focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-white transition-all duration-200 placeholder:text-gray-500 hover:border-gray-600/90 resize-none neon-card-button"
                  ...
                  <div className="group relative">
                    ...
                    <div className="relative">
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        required
                        className="w-full pl-10 pr-10 py-3 bg-gray-800/70 border-2 border-gray-700/80 rounded-lg shadow-sm focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-white transition-all duration-200 appearance-none hover:border-gray-600/90 neon-card-button"
                      >
                    ...
                    <div className="group">
                      ...
                      <div className="relative">
                        ...
                        <input 
                          ...
                          onChange={handleChange}
                          required
                          className="w-full pl-10 pr-4 py-3 bg-gray-800/70 border-2 border-gray-700/80 rounded-lg shadow-sm focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-white transition-all duration-200 hover:border-gray-600/90 calendar-input neon-card-button"
                        />
                      </div>
                    </div>
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      ...
                      <input 
                        ...
                        onChange={handleChange}
                        min="1"
                        className="w-full pl-10 pr-4 py-3 bg-gray-800/70 border-2 border-gray-700/80 rounded-lg shadow-sm focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-white transition-all duration-200 hover:border-gray-600/90 neon-card-button"
                      />
                    </div>
                  </div>
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      ...
                      <input 
                        ...
                        onChange={handleChange}
                        className="w-full pl-10 pr-4 py-3 bg-gray-800/70 border-2 border-gray-700/80 rounded-lg shadow-sm focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-white transition-all duration-200 placeholder:text-gray-500 hover:border-gray-600/90 neon-card-button"
