...
const sampleUsers: UserStats[] = [
  {
    ...
    profile: {      avatar: "https://api.dicebear.com/7.x/personas/svg?seed=BeatMaster&backgroundColor=b91c1c&backgroundType=gradientLinear&mouth=smile&hair=shortHair&hairColor=0e0e0e&accessories=glasses",
      level: 75,
      winStreak: 12,
      totalWins: 156,
