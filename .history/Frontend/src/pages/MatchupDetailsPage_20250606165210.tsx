...
const MatchupDetailsPage: React.FC = () => {
  ...
  const refreshStreamUrls = async () => {
    ...
    try {
      ...
      if (response.ok) {
        const streamData = await response.json();        setStreamUrls(streamData);
        ...
        if (matchup) {
          ...
          if (streamData.streamUrls.player1 && updatedMatchup.player1.submission) {
            const p1Stream = streamData.streamUrls.player1;
            updatedMatchup.player1.submission.streamUrl = p1Stream.embedUrl || p1Stream.streamUrl;
            updatedMatchup.player1.submission.audioType = p1Stream.audioType;
            
            // Update YouTube-specific fields
            if (p1Stream.audioType === 'youtube' && p1Stream.videoId) {
              updatedMatchup.player1.submission.youtubeVideoId = p1Stream.videoId;
              updatedMatchup.player1.submission.youtubeThumbnail = p1Stream.thumbnail;
              updatedMatchup.player1.submission.youtubeDuration = p1Stream.duration;
            }
            
            // Update SoundCloud-specific fields
            if (p1Stream.audioType === 'soundcloud' && p1Stream.trackId) {
              updatedMatchup.player1.submission.soundcloudTrackId = p1Stream.trackId;
              updatedMatchup.player1.submission.soundcloudArtwork = p1Stream.artwork;
              updatedMatchup.player1.submission.soundcloudDuration = p1Stream.duration;
              updatedMatchup.player1.submission.soundcloudUsername = p1Stream.username;
            }
          }
          
          if (streamData.streamUrls.player2 && updatedMatchup.player2.submission) {
            const p2Stream = streamData.streamUrls.player2;
            updatedMatchup.player2.submission.streamUrl = p2Stream.embedUrl || p2Stream.streamUrl;
            updatedMatchup.player2.submission.audioType = p2Stream.audioType;
            
            // Update YouTube-specific fields
            if (p2Stream.audioType === 'youtube' && p2Stream.videoId) {
              updatedMatchup.player2.submission.youtubeVideoId = p2Stream.videoId;
              updatedMatchup.player2.submission.youtubeThumbnail = p2Stream.thumbnail;
              updatedMatchup.player2.submission.youtubeDuration = p2Stream.duration;
            }
            
            // Update SoundCloud-specific fields
            if (p2Stream.audioType === 'soundcloud' && p2Stream.trackId) {
              updatedMatchup.player2.submission.soundcloudTrackId = p2Stream.trackId;
              updatedMatchup.player2.submission.soundcloudArtwork = p2Stream.artwork;
              updatedMatchup.player2.submission.soundcloudDuration = p2Stream.duration;
              updatedMatchup.player2.submission.soundcloudUsername = p2Stream.username;
            }
          }
          ...
          <div className="flex flex-col md:flex-row items-center justify-center mb-8">
            ...
            <div className="md:w-[42%]">              <TrackPlayer 
                track={{
                  ...
                  soundcloudTrackId: matchup.player1.submission?.soundcloudTrackId ? Number(matchup.player1.submission.soundcloudTrackId) : undefined,
                  ...
                  embedUrl: matchup.player1.submission?.streamUrl || undefined
                }}
            ...
            <div className="md:w-[42%]">              <TrackPlayer 
                track={{
                  ...
                  soundcloudTrackId: matchup.player2.submission?.soundcloudTrackId ? Number(matchup.player2.submission.soundcloudTrackId) : undefined,
                  ...
                  embedUrl: matchup.player2.submission?.streamUrl || undefined
                }}
