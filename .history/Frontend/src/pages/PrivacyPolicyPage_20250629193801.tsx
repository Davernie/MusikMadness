      ...
      <div className="w-full max-w-4xl bg-black/20 border border-white/5 backdrop-blur-xl rounded-2xl overflow-hidden">
        ...
        <div className="py-8 px-6 md:px-12">
          ...
          <div className="mb-8 text-center">
            <h1 className="text-4xl font-crashbow text-white tracking-wider mb-2">Privacy Policy</h1>
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            ...
            <section className="space-y-4">
              ...
              <div className="bg-gray-800/40 p-4 rounded-lg border border-gray-700/30">
                <p className="text-cyan-400">Email: privacy@musikmadness.com</p>
                <p className="text-cyan-400">Support: support@musikmadness.com</p>
