                ...
                {(!token || !user) && (
                  <div className="rounded-lg bg-amber-500/10 border border-amber-500/30 p-4 mb-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        <h3 className="text-sm font-medium text-amber-300 mb-1">Authentication Required</h3>
                        <p className="text-sm text-amber-200/80">
                          You can fill out this form to plan your tournament, but you'll need to{' '}
                          <Link to="/login" className="text-amber-300 hover:text-amber-200 underline">
                            log in
                          </Link>{' '}
                          and become a creator to submit it.
                        </p>
                      </div>
                    </div>
                  </div>
