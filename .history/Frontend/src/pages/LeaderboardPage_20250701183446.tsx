...
const ComingSoonTitle = React.memo(() => (
  <div 
    style={{
...
const MainPageTitle = React.memo(() => (
  <div 
    style={{
      contain: 'layout style paint',
      transform: 'translate3d(0,0,0)',
...
const LeaderboardPage = () => {
  ...
  const renderUserCard = (user: UserStats, index: number) => (
    ...
    <div className="container mx-auto px-4 py-8 relative min-h-screen">      {/* Coming Soon Overlay */}      <div className="absolute inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-start justify-center pt-24">
