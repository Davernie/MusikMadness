...
const SettingsPage: React.FC = () => {
  ...
  const renderContent = () => {
    ...
    <div className="relative min-h-screen flex items-center justify-center p-8 text-white">
      {/* Glassmorphic glow effects */}
      <div className="fixed -top-24 -left-24 w-96 h-96 rounded-full bg-blue-500/10 blur-[120px] -z-10" />
      <div className="fixed -bottom-24 -right-24 w-96 h-96 rounded-full bg-pink-500/10 blur-[120px] -z-10" />      
      {/* Content container with glass effect */}
      <div className="w-[1200px] h-[1000px] mt-[-100px] rounded-2xl overflow-hidden backdrop-blur-xl bg-white/[0.02] border border-white/5 relative z-10">
