...
const SettingsPage: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-gray-900/50 via-gray-800/30 to-gray-900/50 text-white">
      ...
      <div className="relative backdrop-blur-[12px] bg-white/[0.02] min-h-screen h-full flex items-center justify-center p-8">
        <div className="w-[1200px] h-[800px] rounded-2xl overflow-hidden backdrop-blur-xl bg-white/[0.02] border border-white/5">
