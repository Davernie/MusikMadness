...
const PageTitle = React.memo(({ children, subtitle }: { children: React.ReactNode; subtitle?: string }) => (
  <div 
    ...
    <div className="min-h-screen flex flex-col items-center py-12 px-4">
      <div className="w-full max-w-4xl bg-black/20 border border-white/5 backdrop-blur-xl rounded-2xl overflow-hidden">
        ...
        <div className="py-8 px-6 md:px-12">
          {/* Title section */}
          <PageTitle subtitle="Everything you need to know about MusikMadness">
            ...
            <section>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-800/40 p-6 rounded-lg border border-gray-700/30">
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    We support submissions from popular streaming platforms including YouTube and SoundCloud. Simply provide the link to your track on these platforms.
                  </p>
                </div>
