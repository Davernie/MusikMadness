...
const SettingsPage: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen bg-transparent text-white">
      ...
      <div className="fixed inset-0 bg-gradient-to-br from-gray-900/30 via-gray-800/20 to-gray-900/30 -z-10" />
      <div className="fixed top-0 left-0 w-[500px] h-[500px] rounded-full bg-blue-500/10 blur-[120px] -z-10" />
      <div className="fixed bottom-0 right-0 w-[500px] h-[500px] rounded-full bg-pink-500/10 blur-[120px] -z-10" />
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-purple-500/5 blur-[120px] -z-10" />
      
      {/* Content container with glass effect */}
      <div className="relative backdrop-blur-[12px] bg-white/[0.02] min-h-screen">
