        ...
        <div className="relative overflow-hidden rounded-xl">
          ...
          <div className="w-full rounded-2xl bg-black/20 border border-white/5 backdrop-blur-xl overflow-hidden">
            <div className="relative p-8">
              {/* Main content */}              <div className="relative space-y-6">
                ...
                {(!token || !user) ? (
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="text-center mb-8">
                      ...
                      {/* Call-to-action */}
                      <div className="rounded-lg bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border border-cyan-500/30 p-6 mb-8">
                        ...
                        <p className="text-gray-300 mb-6">Join our community of music creators and organizers</p>
                  ...
                  /* Actual Tournament Creation Form for Authenticated Users */
                  <>
                    {/* Creator status notice for authenticated non-creators */}
                    {user && !user.isCreator && (
                      <div className="rounded-lg bg-blue-500/10 border border-blue-500/30 p-4 mb-6">
                        <div className="flex items-start">
                          <Info className="h-5 w-5 text-blue-400 mt-0.5 mr-3 flex-shrink-0" />
                          <div>
                            <h3 className="text-sm font-medium text-blue-300 mb-1">Creator Status Required</h3>
                            <p className="text-sm text-blue-200/80">
                              You can fill out this form, but you'll need to{' '}
                              <Link to="/become-creator" className="text-blue-300 hover:text-blue-200 underline">
                                become a creator
                              </Link>{' '}
                              to submit tournaments.
                            </p>
                          </div>
                        </div>
                      </div>
