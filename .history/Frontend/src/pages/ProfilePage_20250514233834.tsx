          ...
          <div className="absolute bottom-0 left-0 right-0 p-8 md:p-10">
            <div className="flex flex-col md:flex-row items-end md:items-end gap-8">
              ...
              <div className="flex-1">
                ...
                <h1 
                  className="text-4xl md:text-5xl font-bold text-white mb-1 leading-none tracking-tight" 
        ...
        <div className="p-6 md:p-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-4 space-y-8">
              ...
              <div className="bg-gradient-to-b from-white/10 to-transparent backdrop-blur-sm rounded-2xl p-8 border border-white/10 relative overflow-hidden">
                <div className="absolute -top-24 -right-24 w-48 h-48 bg-cyan-500/20 rounded-full blur-2xl"></div>
