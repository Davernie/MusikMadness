  ...
  return (
    <div className="min-h-screen py-12 relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(ellipse_at_top_right,_rgba(0,204,255,0.1)_0%,rgba(0,0,0,0)_70%)]"></div>
        <div className="absolute bottom-0 right-0 w-full h-full bg-[radial-gradient(ellipse_at_bottom_left,_rgba(100,0,255,0.08)_0%,rgba(0,0,0,0)_70%)]"></div>
        ...
        <div className="mb-10">
          ...
          <h1 
            ...
            style={{ 
              ...
              textShadow: `0 0 10px rgba(${colors.primary}, 0.1), 0 0 20px rgba(${colors.primary}, 0.3)`
            }}
          >
