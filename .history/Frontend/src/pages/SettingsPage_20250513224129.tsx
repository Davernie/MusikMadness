...
const SettingsPage: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-gray-900/50 via-gray-800/30 to-gray-900/50 text-white">
      {/* Glassmorphic background effects */}
      <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 via-transparent to-pink-500/5" />
      <div className="absolute -top-48 -left-48 w-96 h-96 rounded-full bg-blue-500/10 blur-[100px]" />
      <div className="absolute -bottom-48 -right-48 w-96 h-96 rounded-full bg-pink-500/10 blur-[100px]" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[1000px] rounded-full bg-purple-500/5 blur-[150px]" />
      
      {/* Content container with true glass effect */}
      <div className="relative min-h-screen backdrop-blur-[20px]">
