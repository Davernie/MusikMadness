    ...
    <div className="col-span-12 md:col-span-6 lg:col-span-8 md:col-start-4 lg:col-start-3">
      ...
      <div className="w-full px-4 sm:px-6 pb-16 relative z-10">
        <div className="grid grid-cols-12 gap-4 lg:gap-6">
          ...
          {/* Tournament bracket - Centered with max width constraint */}
          {tournament.status !== 'upcoming' && (
            <div className="col-span-12 flex justify-center">
              <div className="w-full max-w-[95vw] mx-auto">
                <Tabs defaultValue="bracket" className="w-full">
                  <TabsContent value="bracket" className="mt-0">
                    <div className="bg-gray-900/70 backdrop-blur-md rounded-xl shadow-2xl overflow-hidden border border-white/10 p-1 w-full">
                      <TournamentBracket 
                        participants={transformedParticipants}
