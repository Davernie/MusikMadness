...
const SettingsPage: React.FC = () => {
  ...
  const renderContent = () => {
    ...
    <div className="fixed inset-0 w-full min-h-screen bg-gradient-to-br from-gray-900/50 via-gray-800/30 to-gray-900/50 text-white z-[100]">
      ...
      <div className="relative backdrop-blur-[12px] bg-white/[0.02] min-h-screen h-full">
