...
const LeaderboardPage = () => {
  ...
  const renderUserCard = (user: UserStats, index: number) => (
    ...
    <div className="container mx-auto px-4 py-8 relative min-h-screen">      {/* Coming Soon Overlay */}
      <div className="absolute inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-start justify-center pt-24">
        ...
        >
          <motion.h1 
            className="text-8xl md:text-9xl font-crashbow bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-blue-400 to-cyan-400 mb-8"
            animate={{ 
