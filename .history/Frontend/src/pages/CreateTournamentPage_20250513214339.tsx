  ...
  return (
    <div className="min-h-screen py-12 bg-gray-900">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="rounded-xl bg-gray-800 border border-gray-700 p-8 mb-8">
                  ...
                  <div className="bg-gray-900 rounded-xl p-6 border border-gray-700">
                    ...
                    <div className="space-y-4">
                      ...
                      <button
                        type="button"
                        onClick={addRule}
                        className="mt-4 inline-flex items-center px-4 py-2 text-sm font-medium text-cyan-300 bg-cyan-900/30 hover:bg-cyan-800/40 rounded-lg border border-cyan-800/50 transition-all duration-200"
                      >
