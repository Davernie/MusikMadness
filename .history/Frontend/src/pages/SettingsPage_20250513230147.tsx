...
const SettingsPage: React.FC = () => {
  ...
  const renderContent = () => {
    ...
    <div className="relative min-h-screen flex items-center justify-center p-8 text-white">
      ...
      <div className="fixed -bottom-24 -right-40 w-96 h-96 rounded-full bg-pink-500/10 blur-[120px] -z-10" />      
      {/* Content container with glass effect */}
      <div className="w-[1400px] h-[1000px] mt-[-200px] rounded-2xl overflow-hidden backdrop-blur-xl bg-white/[0.02] border border-white/5 relative z-10">
