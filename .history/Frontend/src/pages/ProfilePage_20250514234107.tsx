    ...
    <div className="min-h-screen flex flex-col items-center py-12 px-4 space-y-8">
      ...
      <div className="w-full max-w-[1400px] relative rounded-2xl overflow-hidden">
        ...
        <div className="p-6 md:p-12">
          ...
          <div className="grid grid-cols-3 divide-x divide-white/10 px-8 py-12 bg-gradient-to-b from-black/50 to-black/70 backdrop-blur-sm rounded-2xl border border-black/40 mb-12 shadow-lg shadow-black/20 relative overflow-hidden">
            {/* Darker background */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-4 space-y-8">
              ...
              <div className="bg-gradient-to-b from-black/50 to-black/70 backdrop-blur-sm rounded-2xl p-8 border border-black/40 relative overflow-hidden">
                {/* Darker background */}
