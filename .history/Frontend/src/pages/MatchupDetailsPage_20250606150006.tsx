      ...
      if (response.ok) {
        ...
        if (matchup) {
          ...
          if (streamData.streamUrls.player1 && updatedMatchup.player1.submission) {
            ...
            if (streamData.streamUrls.player1.audioType === 'youtube') {
              updatedMatchup.player1.submission.youtubeVideoId = streamData.streamUrls.player1.videoId;
              updatedMatchup.player1.submission.youtubeThumbnail = streamData.streamUrls.player1.thumbnail;
              updatedMatchup.player1.submission.youtubeDuration = streamData.streamUrls.player1.duration;
            }
          }
          ...
          if (streamData.streamUrls.player2 && updatedMatchup.player2.submission) {
            ...
            // Handle YouTube-specific fields
            if (streamData.streamUrls.player2.audioType === 'youtube') {
              updatedMatchup.player2.submission.youtubeVideoId = streamData.streamUrls.player2.videoId;
              updatedMatchup.player2.submission.youtubeThumbnail = streamData.streamUrls.player2.thumbnail;
              updatedMatchup.player2.submission.youtubeDuration = streamData.streamUrls.player2.duration;
            }
          }
