...
import './MatchupDetailsPage.css                {/* Winner badge */}
                {matchup.winnerParticipantId === matchup.player1.id && (
                  <div className="mt-3 w-full py-2 px-4 bg-yellow-900/30 border border-yellow-600 rounded-lg text-center">
                    <div className="flex items-center justify-center gap-2">
                      <span className="text-sm">🏆</span>
                      <span className="text-sm font-medium text-yellow-400">Winner</span>
                    </div>
                  </div>
                )}mponent to display a matchup between two tracks with voting
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <button 
          ...
          className="group flex items-center text-white transition-all duration-300 mb-8 
                     rounded-lg px-4 py-2 bg-gray-800 hover:bg-gray-700 border border-gray-600"
        >
