  ...
  const refreshStreamUrls = useCallback(async (matchupDataToRefresh?: MatchupData) => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/tournaments/${tournamentId}/matchup/${matchupId}/stream-urls`, {
        ...
        console.log('Stream URLs response:', JSON.stringify(streamDataResponse, null, 2));
        ...
        if (p1Stream && newMatchup.player1.submission) {
          ...
          if (p1Stream.audioType === 'youtube' && p1Stream.videoId) {
            ...
            newMatchup.player1.submission.youtubeThumbnail = p1Stream.thumbnail;
            newMatchup.player1.submission.youtubeDuration = p1Stream.duration;
          } else if (p1Stream.audioType === 'soundcloud' && p1Stream.trackId) {
            newMatchup.player1.submission.soundcloudTrackId = p1Stream.trackId;
            newMatchup.player1.submission.soundcloudArtwork = p1Stream.artwork || undefined;
            newMatchup.player1.submission.soundcloudUsername = p1Stream.username || undefined;
            newMatchup.player1.submission.soundcloudUrl = p1Stream.streamUrl || undefined;
            newMatchup.player1.submission.soundcloudDuration = p1Stream.duration;
          }
          changed = true;
        }
        ...
        if (p2Stream && newMatchup.player2.submission) {
          ...
          if (p2Stream.audioType === 'youtube' && p2Stream.videoId) {
            ...
            newMatchup.player2.submission.youtubeThumbnail = p2Stream.thumbnail;
            newMatchup.player2.submission.youtubeDuration = p2Stream.duration;
          } else if (p2Stream.audioType === 'soundcloud' && p2Stream.trackId) {
            newMatchup.player2.submission.soundcloudTrackId = p2Stream.trackId;
            newMatchup.player2.submission.soundcloudArtwork = p2Stream.artwork || undefined;
            newMatchup.player2.submission.soundcloudUsername = p2Stream.username || undefined;
            newMatchup.player2.submission.soundcloudUrl = p2Stream.streamUrl || undefined;
            newMatchup.player2.submission.soundcloudDuration = p2Stream.duration;
          }
          changed = true;
        }        if (changed) {
          console.log('Updated matchup with stream URLs:', newMatchup);
