    ...
    <div className="min-h-screen flex flex-col items-center py-12 px-4 space-y-8">
      ...
      <div className="w-full max-w-[1400px] relative rounded-2xl overflow-hidden">
        ...
        <div className="p-6 md:p-12">
          ...
          <div className="grid grid-cols-3 divide-x divide-white/10 px-8 py-12 bg-gradient-to-b from-white/20 to-transparent backdrop-blur-sm rounded-2xl border border-white/20 mb-12 shadow-lg shadow-purple-500/10 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-4 space-y-8">
              ...
              <div className="bg-gradient-to-b from-white/20 to-transparent backdrop-blur-sm rounded-2xl p-8 border border-white/20 relative overflow-hidden">
                {/* Reduced transparency */}
