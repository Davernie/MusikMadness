      ...
      try {
        ...
        if (response.ok) {
          ...
          if (data.token && data.user) {
            ...
            // The AuthContext will automatically update when the page redirects
          }
      ...
      case 'success':
        return (
          <div className="text-center">
            ...
            <p className="text-cyan-400/70 text-sm">Redirecting to login page in 3 seconds...</p>
            <Link 
              to="/login" 
        ...
        return (
          <div className="text-center">
            ...
            <Link 
              ...
              className="inline-block bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 px-6 py-2 rounded-md font-medium text-white transition-all duration-300"
            >
              Request New Link
            </Link>
          </div>
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-center text-sm text-cyan-400/70">
            Need help? Contact{' '}
            <a href="mailto:support@musikmadness.com" className="font-medium text-pink-400 hover:text-pink-300 transition-colors duration-300">
              support
            </a>
          </p>
        </div>
