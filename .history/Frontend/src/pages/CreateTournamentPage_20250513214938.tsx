      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10">
          ...
          <div className="relative mt-4 h-1.5">
            <div className="absolute inset-0 h-full bg-gray-800 rounded-full"></div>
            <div 
        ...
        {/* Main card without any background effects */}
        <div className="rounded-xl border border-gray-700 p-8 mb-8 bg-gray-800">
          <form onSubmit={handleSubmit}>
            {/* Step 1: Basic Information */}
            {currentStep === 1 && (
              <div className={stepClasses}>
                <h2 className="text-2xl font-bold text-white mb-8 flex items-center">
                  <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-cyan-700 text-white mr-3">
                ...
                <div className="space-y-8">
                  <div className="group">
                    ...
                    <input 
                      ...
                      required
                      className="w-full px-4 py-3 bg-gray-900 border border-gray-700 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-white transition-colors placeholder:text-gray-500"
                  ...
                  <div className="group">
                    ...
                    <textarea 
                      ...
                      required
                      rows={4}
                      className="w-full px-4 py-3 bg-gray-900 border border-gray-700 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-white transition-colors placeholder:text-gray-500 resize-none"
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        required
                        className="w-full pl-10 pr-10 py-3 bg-gray-900 border border-gray-700 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-white transition-colors appearance-none"
                      >
                    ...
                    <div className="group">
                      ...
                      <div className="relative">
                        ...
                        <input 
                          ...
                          onChange={handleChange}
                          required
                          className="w-full pl-10 pr-4 py-3 bg-gray-900 border border-gray-700 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-white transition-colors calendar-input"
                        />
                      </div>
                    </div>
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      ...
                      <input 
                        ...
                        onChange={handleChange}
                        min="1"
                        className="w-full pl-10 pr-4 py-3 bg-gray-900 border border-gray-700 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-white transition-colors"
                      />
                    </div>
                  </div>
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      ...
                      <input 
                        ...
                        onChange={handleChange}
                        className="w-full pl-10 pr-4 py-3 bg-gray-900 border border-gray-700 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-white transition-colors placeholder:text-gray-500"
              ...
              <div className={stepClasses}>
                ...
                <div className="space-y-8">
                  <div className="bg-gray-900 rounded-xl p-6 border border-gray-700">
                    ...
                    <div className="space-y-4">
                      {formData.rules.map((rule, index) => (
                        <div key={index} className="flex items-start group animate-fadeIn" style={{animationDelay: `${index * 50}ms`}}>
                          <div className="flex-shrink-0 pt-1">
                            <span className="flex items-center justify-center w-7 h-7 rounded-full border border-gray-700 bg-gray-800 text-xs text-gray-300 font-medium">
                              {index + 1}
                            </span>
                          </div>
                          <div className="ml-3 flex-grow">
                            <textarea
                              ...
                              className="w-full px-4 py-2.5 bg-gray-900 border border-gray-700 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-white transition-colors resize-none"
                              rows={2}
                      ...
                      <button
                        type="button"
                        onClick={addRule}
                        className="mt-4 inline-flex items-center px-4 py-2 text-sm font-medium text-cyan-300 bg-cyan-700 hover:bg-cyan-800 rounded-lg transition-all duration-200"
                      >
                  ...
                  {formData.hasPrizePool && (
                    <div className="space-y-6 pt-4 animate-fadeIn bg-gray-900 rounded-xl p-6 border border-gray-700">
                      <h3 className="text-lg font-medium text-cyan-400 mb-4">Prize Details</h3>
                    ...
                    {formData.rules.filter(rule => rule.trim()).length > 0 ? (
                      <ol className="list-decimal list-inside text-gray-300 space-y-2 pl-2">
                        {formData.rules
                          ...
                          .map((rule, index) => (
                            <li key={index} className="pl-1 bg-gray-800 p-2 rounded-lg">{rule}</li>
                          ))
                        }
                      </ol>
                    ) : (
            ...
            <div className="mt-12 flex justify-between items-center">
              ...
              {currentStep < 3 && (
                <button
                  type="button"
                  onClick={nextStep}
                  className="inline-flex items-center px-5 py-2.5 bg-cyan-600 hover:bg-cyan-500 text-white font-medium rounded-lg transition-all duration-200 ml-auto"
                >
                  Next Step
              ...
              {currentStep === 3 && (
                <button
                  ...
                  className={`inline-flex items-center px-6 py-3 font-medium rounded-lg ml-auto transition-all duration-200 ${
                    !formData.title || !formData.description || !formData.genre || !formData.startDate || !formData.endDate
