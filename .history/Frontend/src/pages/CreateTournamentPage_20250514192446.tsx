...
const CreateTournamentPage: React.FC = () => {
  ...
  // Card background style with glassmorphic effects and gradient borders
  const cardBgStyle = {
  ...
  return (
    <div className="min-h-screen py-12 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Enhanced main card */}
        <div className="relative p-8 rounded-xl overflow-hidden backdrop-blur-lg border border-white/10">
