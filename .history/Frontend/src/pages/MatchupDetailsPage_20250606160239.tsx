...
import AnimatedBackground from '../components/profile/AnimatedBackground'; // Assuming AnimatedBackground is here
import { API_BASE_URL } from '../utils/apiConfig'; // Assuming apiConfig is here
...
const MatchupDetailsPage: React.FC = () => {
  ...
  }, [tournamentId, matchupId, token]); // Removed refreshStreamUrls dependency
        ...
        <div className="bg-gray-900/60 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl 
          ...
          <div className="relative p-8">
            ...
            <div className="text-center mb-12 relative">
              ...
              </h1>              <p className="text-gray-300 mt-3 text-lg opacity-80">{matchup.tournamentName}</p>
            </div>
