...
// Single test user credentials for all login attempts
const LOGIN_USER = {
...
export default function () {
  ...
  // Test 2: User Login (all users login with same credentials)
  ...
  // Test 6: Authenticated requests (if we have a token)
  if (authToken) {
    const authHeaders = {
      headers: {
...
export function setup() {
  ...
  console.log('Focus: Login performance test with single user credentials');
