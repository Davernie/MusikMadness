...
export function setup() {
  ...
  console.log('📊 Simulating 1000 users over 1 minute with realistic behavior patterns:');
  ...
  console.log('   15-30s: 500 users online (peak time builds)');
  console.log('   30-45s: 800 users online (near peak traffic)');
  console.log('   45-55s: 1000 users online (peak moment - tournament/viral)');
  console.log('   55-60s: 800 users online (some finish and leave)');
  console.log('');
