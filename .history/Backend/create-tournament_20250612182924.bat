...
if "%1"=="" (
    node scripts\create-test-tournament.js 8
) else if "%2"=="" (
    node scripts\create-test-tournament.js %1
) else if "%3"=="" (
    node scripts\create-test-tournament.js %1 "%2"
) else (
    node scripts\create-test-tournament.js %1 "%2" %3
)
