...
const createFakeSubmissions = async (tournament, participants) => {
  ...
  for (const participant of participants) {
    const submission = new Submission({
      ...
      title: `Submission by ${participant.username}`,
      description: 'This is a fake submission for testing purposes.',
      audioUrl: 'https://example.com/fake-audio.mp3', // Replace with a real URL if needed
      status: 'pending'
    });
  ...
  console.log(`Created ${savedSubmissions.length} fake submissions`);
