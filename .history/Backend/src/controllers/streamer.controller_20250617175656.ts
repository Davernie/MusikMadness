  ...
  try {
    ...
    streamers.forEach(streamer => {
      console.log(`🔍 DEBUG Backend: ${streamer.name}:`, {
        userId: streamer.userId ? (typeof streamer.userId === 'string' ? streamer.userId : streamer.userId._id) : 'NONE',
        userPopulated: !!streamer.userId?.username,
        username: streamer.userId?.username || 'NO USERNAME'
      });
    });
