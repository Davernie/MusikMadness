...
class KickService {
  ...
  isConfigured(): boolean {
    // Return true if either official API credentials are set or we can fall back to unofficial API
    return !!(this.clientId && this.clientSecret) || true; // Always allow fallback
  }
}
