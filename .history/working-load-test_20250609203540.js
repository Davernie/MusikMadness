...
export function teardown(data) {
  console.log('');
  console.log('🎉 Viral signup rush test completed!');
  console.log('📊 Results show how your website handles massive concurrent signups.');
  console.log('💡 This simulates viral moments when everyone signs up at once.');
  console.log('🔥 Great for testing database write performance under pressure!');
}
