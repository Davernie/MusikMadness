...
export const options = {
  stages: [
    { duration: '10s', target: 100 }, // Quick ramp up to 100 users over 10 seconds
    { duration: '10s', target: 200 }, // Quick ramp up to 200 users over 10 seconds
    { duration: '30s', target: 200 }, // Sustained load at 200 users for 30 seconds
