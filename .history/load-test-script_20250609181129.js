...
// Test configuration for full 500-user load testing with fast ramp-up
export const options = {
  stages: [
    { duration: '30s', target: 250 }, // Fast ramp up to 250 users over 30 seconds
    { duration: '30s', target: 500 }, // Fast ramp up to 500 users over 30 seconds
    { duration: '2m', target: 500 },  // Sustained load at 500 users for 2 minutes
    { duration: '30s', target: 0 },   // Fast ramp down to 0 users over 30 seconds
  ],
  thresholds: {
    http_req_duration: ['p(95)<10000'], // More lenient - 95% of requests should be below 10 seconds
    http_req_failed: ['rate<0.3'],      // More lenient - Error rate should be below 30%
    errors: ['rate<0.3'],               // More lenient - Custom error rate should be below 30%
  },
};
